---
title: "Stripe API"
api: "POST https://api.mintlify.com/service/payment/stripe/YOUR_INTEGRATION_NAME"
description: "This endpoint creates a new Stripe API integration"
---

### Body

<ParamField body="STRIPE_SECRET_KEY" type="string">
  The secret key that Stripe generates for you
</ParamField>
...
curl --location --request POST 'https://api.mintlify.com/service/payment/stripe/YOUR_INTEGRATION_NAME' \
